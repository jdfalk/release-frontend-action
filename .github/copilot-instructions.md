...
<!-- version: 1.1.0 -->
<!-- guid: b8c9d0e1-f2a3-4567-b345-678901234567 -->
...
- All changes to frontend release logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that builds and releases frontend applications.
